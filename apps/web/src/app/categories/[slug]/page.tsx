...
import { ArrowLeft, Loader2, ArrowUpDown, LayoutGrid, LayoutList } from "lucide-react";
...
function CategoryPageInner({ slug }: { slug: string }) {
  ...
  // If the user picks a different category in the sidebar, navigate there
  useEffect(() => {
  ...
  if (!meta) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="font-display text-2xl text-antique-text mb-3">
          Category not found
        </h1>
      ...
      <div className="mb-7">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-antique-text-sec mt-1 max-w-2xl">
