...
export const LISTINGS: MockListing[] = [
  ...
  },
  {
    ...
    external_url: "https://www.estatesales.net/WA/Seattle/98105/1234",
    title: "Pair of Signed Imari Chargers — 12 inch, Blue & Red",
    description: "Matched pair of 19th-century Japanese Imari chargers, hand-painted in the classic blue, red and gold palette. Signed with a six-character Arita mark. No chips or cracks. Diameter 12 inches each.",
    category: "Ceramics",
    condition: "Excellent",
    current_price: 385,
    final_price: null,
    ...
    sale_ends_at: hoursFromNow(36),
    sale_starts_at: daysAgo(2),
    primary_image_url: IMG("imari-charger"),
    image_urls: [IMG("imari-charger"), IMG("imari-charger-back")],
    scraped_at: daysAgo(1),
    is_sponsored: false,
  },
  {
  ...
  },
  {
    ...
    title: "Set of 8 Tiffany Sterling Silver Flatware — Olympian Pattern",
    description: "Eight 5-piece place settings (40 pieces) of Tiffany & Co. sterling silver in the 'Olympian' pattern, introduced 1878. All pieces marked sterling and engraved with monogram 'H'. Total weight approx. 3,200 grams.",
    category: "Silver",
    condition: "Very Good",
    current_price: 4200,
    final_price: null,
    ...
    sale_starts_at: daysAgo(3),
    primary_image_url: IMG("tiffany-flatware"),
    image_urls: [IMG("tiffany-flatware"), IMG("tiffany-flatware-2")],
    scraped_at: daysAgo(1),
    is_sponsored: false,
  },
  {
    ...
    description: "Classic Leica M3 double-stroke rangefinder camera (serial 895xxx, circa 1957) with matching 50mm f/2 Summicron collapsible lens. Shutter speeds accurate. Viewfinder clear with some dust. Leather case included.",
